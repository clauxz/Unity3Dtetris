...
public class UIPanel : MonoBehaviour
{
	...
	public Vector3 CalculateConstrainOffset (Vector2 min, Vector2 max)
	{
        ...
        //Debug.Log("CalculateConstrainOffset minRect " + minRect + " maxRect " + maxRect + " minArea " + minArea + " maxArea " + maxArea + " constrain " + NGUIMath.ConstrainRect(minRect, maxRect, minArea, maxArea)); 
